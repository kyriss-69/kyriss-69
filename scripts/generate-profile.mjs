...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1200 360" role="img" aria-labelledby="title description">
  ...
  <defs>
    ...
    <!-- Chemins animés pour l'effet texte dactylographié en boucle -->
    <path id="typePath0">
      <animate id="t0" attributeName="d" begin="0s;t3.end" dur="4.2s" fill="remove"
    ...
    <path id="typePath3">
      <animate id="t3" attributeName="d" begin="t2.end" dur="4.2s" fill="remove"
        values="m108,277 h0 ; m108,277 h540 ; m108,277 h540 ; m108,277 h0"
        keyTimes="0; 0.45; 0.82; 1" />
    </path>
  </defs>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 360" role="img" aria-labelledby="title description">
  ...
  <g transform="translate(60 70)">
    ...
    <g transform="translate(24 16)">
      ...
      <text x="46" y="21" class="sans" fill="${theme.text}" font-size="16" font-weight="750" letter-spacing="-0.2">Google Antigravity (2.0 &amp; IDE)</text>
    ...
    <g transform="translate(24 102)">
      ...
      <text x="46" y="21" class="sans" fill="${theme.text}" font-size="16" font-weight="750" letter-spacing="-0.2">Google Gemini</text>
    ...
    <g transform="translate(24 188)">
      ...
      <text x="46" y="21" class="sans" fill="${theme.text}" font-size="16" font-weight="750" letter-spacing="-0.2">Google Cloud &amp; Vertex AI</text>

      <text x="46" y="42" class="sans" fill="${theme.muted}" font-size="12" font-weight="500">
        Déploiement conteneurisé sur Cloud Run, gestion d&apos;infrastructures modernes,
      </text>
      <text x="46" y="58" class="sans" fill="${theme.muted}" font-size="12" font-weight="500">
